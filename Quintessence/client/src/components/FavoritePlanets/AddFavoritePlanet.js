...
import {
    ...
    postNewFavoritePlanet,
} from "../../modules/favoritePlanetManager";
...
export const AddFavoritePlanetForm = () => {
    ...
    const handleSaveButtonClick = (event) => {
        ...
        if (
            ...
            postNewFavoritePlanet(newFavoritePlanet)
    ...
    return (
        <form className="ticketForm">
            <h2 className="ticketForm__title">Add New Favorite Planet</h2>
            <fieldset>
